...
def lambda_handler(event, context):
    ...
    try:
        ...
        VIDEO_DESCRIPTION = item['videoDescription']  + ' - ' + item['board'] + ' - ' + item['bookName']  + ' - ' + item['bookPartName']  + ' ' + item['chapterName']  + ' ' + item['chapterNumber']  + ' ' + item['chapterPart']  + ' ' + item['classN']  + ' By ' + item['tutorName']  + ' in ' + item['videoLanguage']  + ' ' + item['videoTitle'] #event['VIDEO_DESCRIPTION'] #'Awesome' 
